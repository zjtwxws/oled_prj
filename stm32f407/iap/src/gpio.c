...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : USER_KEY2_Pin USER_KEY3_Pin USER_KEY4_Pin USER_KEY1_Pin */
  GPIO_InitStruct.Pin = USER_KEY2_Pin|USER_KEY3_Pin|USER_KEY4_Pin|USER_KEY1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : USER_LED0_Pin */
